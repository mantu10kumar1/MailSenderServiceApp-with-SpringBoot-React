        ...
        <div className="w-full min-h-screen flex justify-center items-center ">
            <div className="email_card md:w-1/3 w-full mx-4 md:mx-0 dark:bg-gray-700 dark:text-white dark:border-none bg-white p-4 rounded-lg border shadow ">
                ...
                <form action="" onSubmit={handleSubmit}>
                    {/* to */}
                    <div className="input_fiels">
                        <label htmlFor="large-input" className="block mb-2 dark:text-gray-200  text-sm font-medium text-gray-900">To</label>
                        <input type="text"
                            value={emailData.to}
                    ...
                    <div className="button_container mt-4 flex justify-evenly gap-2  ">
                        ...
                        <button className='hover:bg-gray-900  text-white bg-gray-500 px-3 py-2 rounded' >Clear</button>
                    </div>
                </form>
